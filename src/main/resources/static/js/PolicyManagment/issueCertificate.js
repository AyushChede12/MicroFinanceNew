$(document).ready(function() {
	...
	$("#findBtn").click(function() {
		...
		$.ajax({
			url: 'api/Policymangment/getPolicyByPolicyCode', // ✅ backend endpoint
			method: 'GET',
			data: { policyCode: policyCode }, // ✅ send as query param
			dataType: 'json',
			success: function(response) {
	            ...
	            <tr>
	              ...
	              <td>${data.address || ''}</td>
	              <td><a href="#" style="color: green;" class="print-btn"><i class="bi bi-printer-fill"></i></a></td>
	            </tr>`;
