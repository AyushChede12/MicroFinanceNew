        ...
        <div class="id-card">
            ...
            <div class="top-section mt-3">
                ...
                <div class="info">
                    ...
                    <p><label>DOB</label> : <span id="dob"></span></p>
                    <p><label>Age</label> : <span id="age"></span></p>
                    <p><label>Contact No</label> : <span id="contactNo"></span></p>
                    <p><label>District</label> : <span id="district"></span></p>
                ...
                <div class="photo-section">
                    ...
                    <input type="file" accept="image/*" name="financialPhoto" id="financialPhoto"
            ...
            <div class="signature-section">
                ...
                <input type="file" accept="image/*" name="financialSignature" id="signature"
