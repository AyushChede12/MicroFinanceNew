...
<main id="main" class="main">
  ...
  <div>
    <form>
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
            <div class="d-flex flex-column formFields mb-4">
              ...
              <input type="text" name="yearlyROI" id="yearlyROI" required="required"
          ...
          <div class="col-lg-3">
            <div class="d-flex flex-column formFields mb-4">
              ...
              <input type="text" name="initialDeposite" id="initialDeposite" required="required"
          ...
          <div class="col-lg-3">
            <div class="d-flex flex-column formFields mb-4">
              ...
              <input type="text" name="monthlyMinimumBalance" id="monthlyMinimumBalance"
          ...
          <div class="col-lg-3">
            <div class="d-flex flex-column formFields mb-4">
              ...
              <input type="text" name="reservedFunds" id="reservedFunds" required="required"
          ...
          <div class="col-lg-3">
            <div class="d-flex flex-column formFields mb-4">
              ...
              <input type="text" name="messagingFees" id="messagingFees" required="required"
          ...
          <div class="col-lg-3">
            <div class="d-flex flex-column formFields mb-4">
              ...
              <select id="messagingInterval" name="messagingInterval" required="required"
          ...
          <div class="col-lg-3">
            <div class="d-flex flex-column formFields mb-4">
              ...
              <input type="text" name="monthlyFreeIFSCTransactions" id="monthlyFreeIFSCTransactions"
          ...
          <div class="col-lg-3">
            <div class="d-flex flex-column formFields mb-4">
              ...
              <input type="text" name="FreeMoneyTransfers" id="freeMoneyTransfers"
                 required="required" placeholder="Enter Free Money Transfers" />
            </div>
          </div>
          ...
          <div class="col-lg-3">
            <div class="d-flex flex-column formFields mb-4">
              ...
              <input type="text" name="limitperTransaction" id="limitperTransaction"
          ...
          <div class="col-lg-3">
            <div class="d-flex flex-column formFields mb-4">
              ...
              <input type="text" name="dailyLimit" id="dailyLimit" required="required"
          ...
          <div class="col-lg-3">
            <div class="d-flex flex-column formFields mb-4">
              ...
              <input type="text" name="weeklyLimit" id="weeklyLimit" required="required"
          ...
          <div class="col-lg-3">
            <div class="d-flex flex-column formFields mb-4">
              ...
              <input type="text" name="monthlyLimit" id="monthlyLimit" required="required"
          ...
          <div class="col-lg-3">
            <div class="d-flex flex-column formFields mb-4">
              ...
              <input type="text" name="serviceFee" id="serviceFee" required="required"
          ...
          <div class="col-lg-3">
            <div class="d-flex flex-column formFields mb-4">
              ...
              <select id="billingCycle" name="billingCycle" required="required"
                class="form-control selectField" style="height: 30px;">
                <option value="">Select</option>
          ...
          <div class="col-lg-3">
            <div class="d-flex flex-column formFields mb-4">
              ...
              <input type="text" name="cardFee" id="cardFee" required="required"
          ...
          <div class="col-lg-3">
            <div class="d-flex flex-column formFields mb-4">
              ...
              <input type="text" name="monthlyCardLimit" id="monthlyCardLimit" required="required"
          ...
          <div class="col-lg-3">
            <div class="d-flex flex-column formFields mb-4">
              ...
              <input type="text" name="yearlyCardLimit" id="yearlyCardLimit" required="required"
      ...
      <!-- Hidden field for ID to identify record during update -->
      ...
      <div class="row mt-4">
        <div class="col-12 text-center">
          ...
          <!-- Update Button -->
          <button type="button" id="updateBtn" class="btn btn-success" style="margin-left: 10px;">Update</button>
        </div>
      </div>
    </form>
            ...
            <table class="table table-borderless datatable overflow-scroll">
              <thead class="table-light">
                <tr style="font-family: 'Poppins', sans-serif;">
                  ...
                  <th scope="col">Yearly Card Limit</th>
