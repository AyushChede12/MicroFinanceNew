					...
					<div class="row">
						<div class="col-lg-3">
							...
							<div class="d-flex flex-column formFields">
								...
								<small id="chkpolicycodeD" style="color: red;"></small>
							</div>
						</div>
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields">
								...
								<small id="finstallD" style="color: red;"></small>
							</div>
						</div>
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields"
								...
								<small id="tinstallD" style="color: red;"></small>
							</div>
						</div>
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields">
								<label for="">Interest Rate <span id="star"> *</span>( in % )</label> <input type="text" name="ddInterestRate"
									...
									<small id="chkintrestD" style="color: red;"></small>
							</div>
						</div>
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields"
								...
								<small id="chkdeductionD" style="color: red;"></small>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-3">
							...
							<div class="d-flex flex-column formFields">
								...
								<small id="chkpolicycodeR" style="color: red;"></small>
							</div>
						</div>
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields">
								...
								<small id="finstallR" style="color: red;"></small>
							</div>
						</div>
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields"
								...
								<small id="tinstallR" style="color: red;"></small>
							</div>
						</div>
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields">
								<label for="">Interest Rate <span id="star"> *</span>( in % )</label> <input type="text" name="rdInterestRate"
									...
									<small id="chkintrestR" style="color: red;"></small>
							</div>
						</div>
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields"
								...
								<label>Deduction( in % )</label> <input type="text" name="rdDeduction"
									...
									<small id="chkdeductionR" style="color: red;"></small>
					...
					<div class="row">
						<div class="col-lg-3">
							...
							<div class="d-flex flex-column formFields">
								...
								<small id="chkpolicycodeF" style="color: red;"></small>
							</div>
						</div>
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields">
								...
								<small id="finstallF" style="color: red;"></small>
								</div>
						</div>
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields"
								...
								<small id="tinstallF" style="color: red;"></small>
							</div>
						</div>
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields">
								<label for="">Interest Rate <span id="star"> *</span>( in % )</label> <input type="text" name="fdInterestRate"
									...
									<small id="chkintrestF" style="color: red;"></small>
							</div>
						</div>
						...
						<div class="col-lg-3">
							...
							<small id="chkdeductionF" style="color: red;"></small>
							</div>
					...
					<div class="row">
						<div class="col-lg-3">
							...
							<div class="d-flex flex-column formFields">
								...
								<small id="chkpolicycodeM" style="color: red;"></small>
							</div>
						</div>
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields">
								...
								<small id="finstallM" style="color: red;"></small>
							</div>
						</div>
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields"
								...
								<small id="tinstallM" style="color: red;"></small>
							</div>
						</div>
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields">
								<label for="">Interest Rate <span id="star"> *</span>( in % )</label> <input type="text" name="misInterestRate"
									...
									<small id="chkintrestM" style="color: red;"></small>
							</div>
						</div>
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields"
								...
								<label>Deduction ( in % )</label> <input type="text" name="misDeduction"
									...
									<small id="chkdeductionM" style="color: red;"></small>
