...
<body onload="setUserName(); loadSidebar(sessionUser);">
		...
		<div>
			...
			<div class="box-group">
				...
				<div class="user-box">
					...
					<div class="member-row">
						<div class="checkbox-col">
							<input type="checkbox" id="myCompanyAdministration"
								name="service" value="Company Administration">
						</div>
					...
					<div class="member-row">
						<div class="checkbox-col">
							<input type="checkbox" id="myCasteModule" name="service"
								value="Caste Module">
						</div>
						<div class="bold-text">Preferences =></div>
				...
				<div class="user-box">
					...
					<div class="member-row">
						<div class="checkbox-col" id="myLedgerAccountMaster"
							name="service">
							<input type="checkbox" value="Ledger Account Master">
						</div>
					...
					<div class="member-row">
						<div class="checkbox-col">
							<input type="checkbox" id="myFundsTransferRegister"
								name="service" value="Funds Transfer Register">
						</div>
						<div class="bold-text">Account Management =></div>
				...
				<div class="user-box">
					...
					<div class="member-row">
						<div class="checkbox-col">
							<input type="checkbox" id="mySavingAccountActivity"
								name="service" value="Saving Account Activity">
						</div>
						<div class="bold-text">Customer Savings =></div>
					...
					<div class="member-row">
						<div class="checkbox-col">
							<input type="checkbox" id="mySavingsAccountFundsTransfer"
								name="service" value="Savings Account Funds Transfer">
						</div>
						<div class="bold-text">Customer Savings =></div>
					...
					<div class="member-row">
						<div class="checkbox-col">
							<input type="checkbox" id="mySavingsAccountInquiry"
								name="service" value="Savings Account Inquiry">
						</div>
						<div class="bold-text">Customer Savings =></div>
				...
				<div class="user-box">
					...
					<div class="member-row">
						<div class="checkbox-col">
							<input type="checkbox" id="myFlexiblePremiumRenewal"
								name="service" value="Flexible Premium Renewal">
						</div>
						<div class="bold-text">Policy Management =></div>
					...
					<div class="member-row">
						<div class="checkbox-col">
							<input type="checkbox" id="myInstallmentRecordBook"
								name="service" value="Installment Record Book">
						</div>
						<div class="bold-text">Policy Management =></div>
				...
				<div class="user-box">
					...
					<div class="member-row">
						<div class="checkbox-col">
							<input type="checkbox" id="myIrregularLoanStatement"
								name="service" value="Irregular Loan Statement">
						</div>
						<div class="bold-text">Loan Management =></div>
					...
					<div class="member-row">
						<div class="checkbox-col">
							<input type="checkbox" id="myGenerateNOCCertificate"
								name="service" value="Generate NOC Certificate">
						</div>
						<div class="bold-text">Loan Management =></div>
				...
				<div class="user-box">
					...
					<div class="member-row">
						<div class="checkbox-col">
							<input type="checkbox" id="myApproveRecurringDeposits"
								name="service" value="Approve Recurring Deposits">
						</div>
						<div class="bold-text">Request Approvals =></div>
					...
					<div class="member-row">
						<div class="checkbox-col">
							<input type="checkbox" id="myDeleteMaturityApplicationsRequest"
								name="service" value="Delete Maturity Applications Request">
						</div>
						<div class="bold-text">Request Approvals =></div>
				...
				<div class="user-box">
					...
					<div class="member-row">
						<div class="checkbox-col">
							<input type="checkbox" id="myShareholdingAdjustment"
								name="service" value="Shareholding Adjustment">
						</div>
						<div class="bold-text">Data Correction =></div>
					...
					<div class="member-row">
						<div class="checkbox-col">
							<input type="checkbox" id="myRenewalDataCorrection"
								name="service" value="Renewal Data Correction">
						</div>
						<div class="bold-text">Data Correction =></div>
					...
					<div class="member-row">
						<div class="checkbox-col">
							<input type="checkbox" id="myLoanAccountCorrection"
								name="service" value="Loan Account Correction">
						</div>
						<div class="bold-text">Data Correction =></div>
				...
				<div class="user-box">
					...
					<div class="member-row">
						<div class="checkbox-col">
							<input type="checkbox" id="myPartialMaturityPayment"
								name="service" value="Partial Maturity Payment">
						</div>
						<div class="bold-text">Maturity Management =></div>
				...
				<div class="user-box">
					...
					<div class="member-row">
						<div class="checkbox-col">
							<input type="checkbox" id="myIncentiveSchemeMaster"
								name="service" value="Incentive Scheme Master">
						</div>
					...
					<div class="member-row">
						<div class="checkbox-col">
							<input type="checkbox" id="myIncentiveSummaryReport"
								name="service" value="Incentive Summary Report">
						</div>
						<div class="bold-text">Incentive Management =></div>
				...
				<div class="user-box">
					...
					<div class="member-row">
						<div class="checkbox-col">
							<input type="checkbox" id="myAddFinancialConsultant"
								name="service" value="Add Financial Consultant">
						</div>
					...
					<div class="member-row">
						<div class="checkbox-col">
							<input type="checkbox" id="myConsultantDownlineView"
								name="service" value="Consultant Downline View">
						</div>
						<div class="bold-text">Financial Consultant =></div>
