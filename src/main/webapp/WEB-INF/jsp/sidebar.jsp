		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				<ul id="member-share" class="nav-content collapse">
					...
					<li><a href="regenerateDNO"> <i class="bi bi-circle"></i>
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				<ul id="account-section" class="nav-content collapse">
					...
					<li><a href="outgoingPaymentEntry"> <i
							class="bi bi-circle"></i> <span
							style="font-family: 'Poppins', sans-serif">Outgoing
								Payment Entry</span>
					</a></li>

					<li><a href="incomingReceiptEntry"> <i
							class="bi bi-circle"></i> <span
					...
					<li><a href="mandateDepositToBank"> <i
							class="bi bi-circle"></i> <span
							style="font-family: 'Poppins', sans-serif">Mandate Deposit
								To Bank</span>
					</a></li>

					<li><a href="bankStatement"> <i class="bi bi-circle"></i>
					...
					<li><a href="dailyTransactionBook"> <i
							class="bi bi-circle"></i> <span
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				<ul id="saving-account" class="nav-content collapse">
					<li><a href="savingsSchemaCatalog"> <i
							class="bi bi-circle"></i> <span
							style="font-family: 'Poppins', sans-serif">Savings Scheme
								Catalog</span>
					</a></li>

					<li><a href="createSavingsAccount"> <i
							class="bi bi-circle"></i> <span
          ...
          <li>
            <a href="loanSchemeCatalog">
              ...
              <span style="font-family: 'Poppins', sans-serif">Loan Scheme Catalog</span>
					...
					<li><a href="smsServiceFee"> <i class="bi bi-circle"></i>
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				<ul id="investment-section" class="nav-content collapse">
					...
					<li><a href="investmentDataSearch"> <i
							class="bi bi-circle"></i> <span
							style="font-family: 'Poppins', sans-serif">Investment Data
								Search</span>
					</a></li>
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				<ul id="group-loan-section" class="nav-content collapse">
					...
					<li><a href="earlyLoanClosureJointLiability"> <i
							class="bi bi-circle"></i> <span
							style="font-family: 'Poppins', sans-serif">Early Loan
								Closure</span>
					</a></li>

					<li><a href="completedLoansRecord"> <i
							class="bi bi-circle"></i> <span
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				<ul id="approval-section" class="nav-content collapse">
					...
					<li><a href="approvePolicy"> <i class="bi bi-circle"></i>
							<span style="font-family: 'Poppins', sans-serif">Approve
								Policy</span>
					</a></li>
					...
					<li><a href="approveSavingAccount"> <i
							class="bi bi-circle"></i> <span
					...
					<li><a href="approveManualPayment"> <i
							class="bi bi-circle"></i> <span
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				<ul id="maturity-section" class="nav-content collapse">
					<li><a href="maturitySchemeMaster"> <i
							class="bi bi-circle"></i> <span
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				<ul id="employee-section" class="nav-content collapse">
					...
					<li><a href="addTeamMember"> <i class="bi bi-circle"></i>
