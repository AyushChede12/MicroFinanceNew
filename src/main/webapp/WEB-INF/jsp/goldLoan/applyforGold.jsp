				...
				<div>
					...
					<div class="row">
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields"
								style="margin-bottom: 30px">
								<label>LOAN PLAN NAME</label> <input type="text"
				...
				<div class="mt-5">
					...
					<div class="row">
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields">
								<label for="">ADDRESS</label>
								<textarea name="guarantorAddress" id="guarantorAddress" placeholder="ENTER ADDRESS"
									style="border: 1px solid rgb(224, 224, 224); border-radius: 5px; outline: none; padding: 5px; font-size: 12px;"
									readonly="readonly"></textarea>
							</div>
						</div>
				...
				<div class="mt-5">
					...
					<div class="row">
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields">
								<label for="">Address</label>
								<textarea name="coApplicantAddress" id="coApplicantAddress" placeholder="ENTER ADDRESS"
									style="border: 1px solid rgb(224, 224, 224); border-radius: 5px; outline: none; padding: 5px; font-size: 12px;"
									readonly="readonly"></textarea>
							</div>
						</div>
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields">
								<label for="">CO-APPLICANT CONTACT NO.</label> <input
									...
									placeholder="ENTER CO-APPLICANT CONTACT NO." readonly="readonly" />
							</div>
						</div>
