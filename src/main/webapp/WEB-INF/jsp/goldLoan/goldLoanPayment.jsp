...
<body>
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields mb-4">
								<label for="">Loan Term</label> <input type="text"
									...
									readonly="readonly" placeholder="Enter Plan Duration"
									style="text-transform: uppercase;" />
							</div>
						</div>
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields mb-4">
								<label for="">Loan Mode</label> <input type="text"
									...
									readonly="readonly" placeholder="Loan Category"
									style="text-transform: uppercase;" />
							</div>
						</div>
						<div class="col-lg-3">
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields mb-4">
								<label for="">Item Name</label> <input type="text"
									...
									readonly="readonly" placeholder="Enter Item Name" />
							</div>
						</div>
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields mb-4">
								<label for="purity">Purity</label> <input type="text"
									...
									readonly="readonly" placeholder="Enter Purity" />
							</div>
						</div>
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields mb-4">
								<label for="">Item Weight</label> <input type="text"
									...
									readonly="readonly" placeholder="Enter Item Weight" />
							</div>
						</div>
	...
	<script src="./js/SecuredGoldLoan/GoldPayment.js"></script>
</body>
