					...
					<div class="row">
						<div class="col-lg-3">
							...
							<div class="d-flex flex-column formFields mb-4">
								<label for="">Plan Code <span class="star">*</span></label> <input
									...
									required="required" placeholder="Enter Plan Code"
									value="${memberCodeDD}" readonly="readonly"
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields">
								...
								<input type="text" name="renewalCommission"
									id="renewalCommission" required="required"
				...
				<div>
					...
					<div class="row">
						<div class="col-lg-3">
							...
							<div class="d-flex flex-column formFields">
								<label for="">Plan Code <span class="star">*</span></label> <input
									type="text" name="planCodeRD" id="planCodeRD"
									required="required" placeholder="Enter Plan Code"
									value="${memberCodeRD}" readonly="readonly"
									style="text-transform: uppercase;" />
							</div>
						</div>
						<div class="col-lg-3 ">
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields">
								<label for="vehicalNo">Interest Rate(%) <span
									...
									name="rateOfInterestRD" id="rateOfInterestRD"
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields">
								...
								<input type="text" name="commissionOnNewRD"
									id="commissionOnNewRD" required="required"
					...
					<div class="row">
						<div class="col-lg-3">
							...
							<div class="d-flex flex-column formFields">
								<label for="">Plan Code <span class="star">*</span></label> <input
									...
									required="required" value="${memberCodeFD}" readonly="readonly"
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields">
								<label for="vehicalNo">Interest Rate(%) <span
									class="star">*</span></label> <input type="text"
									name="rateOfInterestFD" id="rateOfInterestFD"
									required="required" placeholder="Enter Interest Rate"
									style="text-transform: uppercase;" />
							</div>
						</div>
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields">
								<label for="">New Commission(%) <span class="star">*</span></label>
								<input type="text" name="commissionOnNewFD"
									id="commissionOnNewFD" required="required"
									placeholder="Enter Comm.New(%)" />
							</div>
						</div>
						<div class="col-lg-3 mb-4 ">
					...
					<div class="row">
						<div class="col-lg-3">
							...
							<div class="d-flex flex-column formFields">
								<label for="">Plan Code <span class="star">*</span></label> <input
									...
									required="required" placeholder="Enter Plan Code"
									value="${memberCodeMD}" readonly="readonly"
									style="text-transform: uppercase;" />
							</div>
						</div>
						<div class="col-lg-3 ">
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields">
								<label for="vehicalNo">Interest Rate(%) <span
									class="star">*</span></label> <input type="text"
									name="rateOfInterestMD" id="rateOfInterestMD"
									required="required" placeholder="Enter Interest Rate"
									style="text-transform: uppercase;" />
							</div>
						</div>
						...
						<div class="col-lg-3">
							<div class="d-flex flex-column formFields">
								<label for="">New Commission(%) <span class="star">*</span></label>
								<input type="text" name="commissionOnNewMD"
									id="commissionOnNewMD" required="required"
									placeholder="Enter Comm.New(%)" />
							</div>
						</div>
