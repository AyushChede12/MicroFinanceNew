    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item action">Saving Intra-Account Transfer</li>
        </ol>
      </nav>
    </div>
          ...
          <div class="row">
            <div class="col-lg-3">
              <div class="d-flex flex-column formFields">
                <label for="">Select Account Number</label> <select id="colour" name="colour" required="required"
            ...
            <div class="col-lg-3">
              ...
              <div class="col-lg-3">
                <div class="d-flex flex-column formFields mb-4">
                  <label for="">Account Branch</label> <input type="text" name="price" id="price" required="required"
                    placeholder="" />
                </div>
              </div>
        ...
        <div class="mt-5">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                  ...
                  <div class="col-lg-3">
                    <div class="d-flex flex-column formFields mb-4">
                      <label for="">Amount</label> <input type="text" name="price" id="price" required="required"
                        placeholder="" />
                    </div>
                </div>
