            ...
            <form id="formid">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="d-flex flex-column formFields mb-4">
                                <label for="">General Name</label> <input type="text" name="price" id="price"
                        ...
                        <div class="col-lg-3">
                            <div class="d-flex flex-column formFields mb-4">
                                <label for="">Comments</label> <input type="text" name="price" id="price"
                                    required="required" placeholder="Member Code" />
                            </div>
                        </div>
                ...
                <div class="mt-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="d-flex flex-column formFields mb-4">
                                <label for="">Search By General Code</label> <select id="colour" name="colour"
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <button id="saveBtn" class="btn btn-warning"
                            style="margin-left: 80%; background-color: orange;">Search Data</button>
                    </div>
                </div>
            </form>
